...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        // $_FILES images temp place and $_FILES error= all the error info upload_err_ok=0(no errors)
...
<html lang="lv">
<head>
    <title>Izveidot ieteikumu</title>
...
<script>
    ...
    <form class="form" method="POST" action="" enctype="multipart/form-data">
        ...
        <input class="submit" type="submit" name="submit" value="Izveidot ieteikumu">
